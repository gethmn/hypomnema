...
- `notes/proposals/search-result-payload-budget.md` — Primary proposal defining the feature
- `notes/proposals/search-result-payload-budget-stories.md` — Acceptance criteria for six user stories
...
|---|---|---|
| `notes/proposals/search-result-payload-budget.md` | proposal | primary — defines the feature, design constraints, and implementation notes |
| `notes/proposals/search-result-payload-budget-stories.md` | stories | primary — six acceptance-criteria user stories covering all changes |
