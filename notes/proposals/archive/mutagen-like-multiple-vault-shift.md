...
> **Archived 2026-04-27 — outcome: CONSUMMATED.** This exploration produced ADR-0009 (multi-vault per daemon), ADR-0010 (vault definitions as runtime state), ADR-0011 (vault management on `hmn`), and the round-3 entry in [`notes/roadmap/archive/roadmap-2.md`](../../roadmap/archive/roadmap-2.md). The Mutagen-shaped management UX (compose-style declarative provisioning) is preserved in the round-3 deferred-decisions list. Frozen here for the original reasoning trail.
