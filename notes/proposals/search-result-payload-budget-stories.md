...
This story artifact pairs with `notes/proposals/search-result-payload-budget.md`. It defines delivery scope for keeping search responses useful without consuming excessive agent context.
